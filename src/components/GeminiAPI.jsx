...
function GeminiAPI() {
  ...
  return (
    <div className="w-full bg-hero2-pattern bg-cover comic-neue-regular min-h-screen flex justify-center items-end bg-slate-50">
      <div className="w-full h-auto flex flex-col justify-center mb-8 gap-5">
        <div className="w-full flex justify-center mb-20 mt-5">
          ...
          {loading ? (
            <p className="w-8/12 sm:w-5/12 mb-16 sm:mb-0 flex justify-start items-center gap-2 sm:gap-4 text-lg">
              {" "}
              <img
                src={textanimation}
                className="w-10 h-5 font-bold"
                alt="loading..."
              />{" "}
              Scenes creation is underway.
            </p>
          ) : (
